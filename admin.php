        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-white" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
                    <a class="list-group-item list-group-item-action list-group-item-light p-3 active" href="admin.php">Home</a>
            ...
            <div id="page-content-wrapper">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ms-auto mt-2 mt-lg-0">
                                <li class="nav-item active"><a class="btn btn-danger" href="index.php">Log Out</a></li>     
                ...
                <!-- Page content-->
                <div class="container-fluid">
                    <h1 class="mt-4">Selamat Datang <?php echo $_SESSION['name'];?></h1></h1>
